...
class Node(threading.Thread):
    ...
    def outbound_node_connected(self, node):
        ...
        self.connected_peers.append(str(node.host+":"+node.port))

        self.debug_print("outbound_node_connected: " + str(node.host) + ":" + str(node.port))#was node.id
    ...
    def inbound_node_connected(self, node):
        ...
        self.debug_print("inbound_node_connected: " + str(node.host) + ":" + str(node.port))#was node.id
        if self.callback is not None:
    ...
    def inbound_node_disconnected(self, node):
        """This method is invoked when a node, that was previously connected with us, is in a disconnected
           state."""
        self.debug_print("inbound_node_disconnected: " + str(node.host) + ":" + str(node.port))#was node.id
        if self.callback is not None:
    ...
    def outbound_node_disconnected(self, node):
        ...
        self.debug_print("outbound_node_disconnected: " + str(node.host) + ":" + str(node.port))#was node.id
        if self.callback is not None:
            self.callback("outbound_node_disconnected", self, node, {})

    def node_message(self, node, data):
        """This method is invoked when a node send us a message."""
        self.debug_print("node_message: " + str(node.host) + ":" + str(node.port) + ": " + str(data))
    ...
    def node_disconnect_with_outbound_node(self, node):
        ...
        self.debug_print("node wants to disconnect with oher outbound node: " + str(node.host) + ":" + str(node.port))#was node.id
        if self.callback is not None:
